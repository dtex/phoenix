...
var board = new five.Board().on("ready", function() {
  ...
  // Right front leg
  phoenix.r1c = new five.Servo({pin:40, offset: 67, startAt: l.c, range: [-1, 88], invert: true });
  phoenix.r1f = new five.Servo({pin:39, offset: -2, startAt:  l.f, range: [69, 177] });
  phoenix.r1t = new five.Servo({pin:38, offset: 15, startAt: l.t, range: [0, 165] });
  phoenix.r1 = new five.Servo.Array([ phoenix.r1c, phoenix.r1f, phoenix.r1t ]);

  //Left front leg
  phoenix.l1c = new five.Servo({pin:27, offset: 59, startAt: l.c, range: [-1, 88] });
  phoenix.l1f = new five.Servo({pin:26, offset: -13, startAt: l.f, range: [25, 177], invert: true });
  phoenix.l1t = new five.Servo({pin:25, offset: 3, startAt: l.t, range: [0, 165], invert: true });
  phoenix.l1 = new five.Servo.Array([ phoenix.l1c, phoenix.l1f, phoenix.l1t ]);

  //Right mid leg
  phoenix.r2c = new five.Servo({pin:49, offset: 4, startAt: l.c, range: [50, 109], invert: true });
  phoenix.r2f = new five.Servo({pin:48, offset: -12, startAt: l.f, range: [25, 177] });
  phoenix.r2t = new five.Servo({pin:47, offset: -7, startAt: l.t, range: [0, 165] });
  phoenix.r2 = new five.Servo.Array([ phoenix.r2c, phoenix.r2f, phoenix.r2t ]);

  //Left mid leg
  phoenix.l2c = new five.Servo({pin:23, offset: 6, startAt: l.c, range: [50, 109] });
  phoenix.l2f = new five.Servo({pin:21, offset: -15, startAt: l.f, range: [25, 177], invert: true });
  phoenix.l2t = new five.Servo({pin:20, offset: -7, startAt: l.t, range: [0, 165], invert: true });
  phoenix.l2 = new five.Servo.Array([ phoenix.l2c, phoenix.l2f, phoenix.l2t ]);

  //Right rear leg
  phoenix.r3c = new five.Servo({pin:45, offset: 65, startAt: l.c, range: [0, 100]});
  phoenix.r3f = new five.Servo({pin:44, offset: -10, startAt: l.f, range: [25, 177] });
  phoenix.r3t = new five.Servo({pin:43, offset: -3, startAt: l.t, range: [0, 165] });
  phoenix.r3 = new five.Servo.Array([ phoenix.r3c, phoenix.r3f, phoenix.r3t ]);

  //Left rear leg
  phoenix.l3c = new five.Servo({pin:19, offset: 52, startAt: l.c, range: [0, 100], invert: true });
  phoenix.l3f = new five.Servo({pin:18, offset: -6, startAt: l.f, range: [25, 177], invert: true });
  phoenix.l3t = new five.Servo({pin:17, offset: 0, startAt: l.t, range: [0, 165], invert: true });
